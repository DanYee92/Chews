...
var insertKeyframesRule = require("../../../node_modules/domkit/insertKeyframesRule");
...
module.exports = modalFactory({
  ...
  getBackdropStyle: function(willHidden) {
    return appendVendorPrefix({
      ...
      animationTimingFunction: (willHidden ? hideAnimation : showAnimation)
  ...
  getContentStyle: function(willHidden) {
    return appendVendorPrefix({
      ...
      animationDuration: (willHidden ? hideAnimation : showAnimation)
        .animationDuration,
      animationFillMode: "forwards",
