...
module.exports = app => {
                          ...
                          app.get(
                            "/api/bites/search/city/:city",
                            (req, res) =>
                              biteController.searchForBites(
                                req,
                                res
                              )
                          );
                          ...
                          app.get(
                            "/api/user/:userId/bites/booked",
                            (req, res) =>
                              userController.getUserBookedBites(
                                req,
                                res
                              )
                          );
                          ...
                          app.get(
                            "/api/user/:userId/bites/unbooked",
                            (req, res) =>
                              userController.getUserUnbookedBites(
                                req,
                                res
                              )
                          );
